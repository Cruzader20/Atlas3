...
const findSimilarCities = () => {
  ...
  console.log(similarityResults)
    ...
    return (
      ...
      <button onClick={() => addNewPlace('NewCity', 'NewPlace', 'NewCategory')}>
                Add New Venue
            </button>
...
<div>
  <label htmlFor="userCityInput">Enter the Venue:</label>
  <input
    type="text"
    id="userCityInput"
    value={userCity}
  ...
  />
  <button onClick={findSimilarCities}>Find Similar Venues</button>
